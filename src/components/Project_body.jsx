    ...
    return(
        <div id="portfolio" className="section">
            <div className="container text-center">
                ...
                <p className="mb-5 pb-4">Here you can find some web applications and ML based projects.</p>
                <p className="mb-5 pb-4">You can visit <a href={gitlnk} target="_blank">here</a> for more small projects.</p>
